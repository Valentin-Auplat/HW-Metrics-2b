...
#adf_test <- ur.df(df_long, type = "trend", lags = 4)  # Try "drift" or "none" too
#summary(adf_test)

# 2.2 PP Test (Phillips-Perron)
#pp_test <- ur.pp(df_long, type = "Z-tau", model = "trend", lags = "short")
#summary(pp_test)

# 2.3 KPSS Test (Stationarity)
#kpss_test <- ur.kpss(df_long, type = "tau", lags = "short")
#summary(kpss_test)
```